...
public class PageNavigation {
	...
	public UiObject getReadTab(){
		return UiObjectHelper.getUiObjectByIdAndInstanceIndex("com.netease.newsreader"
				+ ".activity:id/biz_navi_tab", 1);
	}
	/**
	 * 获得我tab页
	 * @return
	...
	public UiObject getNewsTab() throws UiObjectNotFoundException{
		return UiObjectHelper.getUiObjectByIdAndInstanceIndex("com.netease.newsreader"
				+ ".activity:id/biz_navi_tab", 0);
	}
	/**
	 * 切换到我tab页
	 */
	public void goToMySettingTab(){
		try {
